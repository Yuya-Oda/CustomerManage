...
//        CustomerBean customerEdit = (CustomerBean)  request.getSession().getAttribute("customerEdit");
        CustomerDao customerDao = new CustomerDao();
    ...
    public String delete(CustomerBean customer) {
        ...
        errMessage = cutomerDao.delete(customer.getId());
        if (errMessage != null) {
    ...
    public void setCustomerBeanFromRequestToSession(HttpServletRequest request) {
        ...
        // TODO 未実装
        CustomerBean customer = (CustomerBean)request.getSession().getAttribute("customerEdit");
        if (customer == null) {
            customer = new CustomerBean();
        }

        customer.setId(Integer.parseInt(request.getParameter("id")));
        customer.setName(StringUtil.exchangeESCEncoding(request.getParameter("customer_name")));
